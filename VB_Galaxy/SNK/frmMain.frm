...
Private Sub Form_Resize()
    ...
    lstFiles.Width = frmMain.ScaleWidth
...
Dim lngTemp As Long
    ...
    'Make a new spank file
    cmdDialog.FileName = ""
    cmdDialog.Flags = HideReadOnly Or OverWritePrompt
    cmdDialog.Filter = "Spank Files (*.snk)|*.snk"
...
Dim blnWAVS As Boolean
Dim blnWAVFirst As Boolean
...
Dim lngTemp As Long
    ...
    Do While Not (blnComplete)
        ...
        If blnWAVS Then
            If blnWAVFirst Then
                strTemp = Dir(strDir(intDirNum) & "\*.WAV")
                blnWAVFirst = False
            Else
                strTemp = Dir()
            End If
            If strTemp = "" Then
                'No more WAVs in this subdir
                blnWAVS = False
            Else
